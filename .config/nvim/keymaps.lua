...
DefKeymap{
  ...
  vim_tab_next = { '<leader>]', mode = { 'n' }, desc = 'Tab next' },
  vim_tab_prev = { '<leader>[', mode = { 'n' }, desc = 'Tab previous' },
  ...
  search_live_grep = { '<leader>/', mode = { 'n' }, desc = 'Search project grep' },
  search_grep = { '<leader><space>', mode = { 'n' }, desc = 'Search grep' },
  ...
  fix_whitespace = { '<leader>w', mode = { 'n' }, desc = 'Fix [w]hitespace' },
}
