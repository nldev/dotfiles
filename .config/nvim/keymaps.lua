...
DefKeymap({
  ...
  fuzzy_color_schemes = { 'c', prefix = 'vim', mode = { 'n' }, desc = 'Fuzzy color schemes' },
  ...
  empty_file = {'e', prefix = 'empty', mode = { 'n' }, desc = 'Create [e]mpty file' },
  empty_json_file = {'j', prefix = 'empty', mode = { 'n' }, desc = 'Create [e]mpty JSON file' },
})
