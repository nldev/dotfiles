...
DefKeymap{
  ...
  vim_trim_dos = { 'm', prefix = 'vim', mode = { 'n' }, desc = 'Trim [M]S-DOS endings'},
  ...
  lsp_info = { '<leader>i', mode = { 'n' }, desc = 'LSP [i]nfo' },
  ...
  sort_lines = { '<leader>m', mode = { 'x' }, desc = 'Sort lines alphebetically' },
  sort_lines_reverse = { '<leader>M', mode = { 'x' }, desc = 'Sort lines reverse alphebetically' },
  ...
  empty_file = { 'n', prefix = 'open_new', mode = { 'n' }, desc = '[N]ew file' },
  empty_json_file = { 'j', prefix = 'open_new', mode = { 'n' }, desc = 'New [J]SON file' },
  empty_lua_file = { 'l', prefix = 'open_new', mode = { 'n' }, desc = 'New [L]ua file' },
  empty_vim_file = { 'v', prefix = 'open_new', mode = { 'n' }, desc = 'New [V]im file' },
